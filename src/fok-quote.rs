...
fn main() {
    ...
    if args.len() > 1 {
        ...
        let tuple = config.get("quotes".to_string()).value.to_list().unwrap()[last_id as usize]
            .value
            .clone()
            .to_list()
            .unwrap();
    ...
    println!(
        " {}\n|{}|\n|{}{}{}|\n|{}|\n {}\n{}\\/",
        border,
        mul_string(" ", quote.len() as i32 + 8),
        mul_string(" ", 4),
        quote,
        mul_string(" ", 4),
        mul_string(" ", quote.len() as i32 + 8),
        border,
        mul_string(" ", (quote.len() as i32))
    );
    ...
    println!(
        "{}~ {}",
        mul_string(" ", /*quote.len() as i32+*/ 56),
        author
    );
